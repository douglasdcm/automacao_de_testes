...
def test_button(page: Page):
    page.goto("https://manojkumar4636.github.io/Selenium_Practice_Hub/pages/Button.html")
    ...
    button_position = page.get_by_role("button").filter(has_text="Get position").bounding_box()
    ...
    button_position = page.get_by_role("button").filter(has_text="What is my size?").bounding_box()
